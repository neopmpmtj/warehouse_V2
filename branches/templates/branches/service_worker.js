...
var CACHE_NAME = "centcompras-branch-v21";
...
var APP_SHELL = [
    ...
    "{% static 'products/js/preferences_bar.js' %}?v=12",
    ...
    "{% static 'orders/js/branch_requests_i18n.js' %}?v=2",
    "{% static 'orders/js/branch_requests.js' %}?v=11",
