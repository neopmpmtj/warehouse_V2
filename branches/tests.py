...
class ServiceWorkerTests(TestCase):
    def test_service_worker_served_at_root(self):
        ...
        self.assertContains(response, "centcompras-branch-v31")
...
class BranchViewTests(TestCase):
    ...
    def test_dashboard_renders_cards(self):
        ...
        self.assertContains(response, 'href="/branch/consumption/"')
        self.assertContains(response, 'href="/branch/send-to-warehouse/"')
        ...
        self.assertIn('href="/branch/stock/"', work)
        self.assertIn('href="/branch/consumption/"', work)
        self.assertIn('href="/branch/send-to-warehouse/"', work)
    ...
    def test_catalog_renders_with_active_branch(self):
        ...
        self.assertContains(response, 'data-i18n="navBranchStock"')
        self.assertContains(response, 'data-i18n="navBranchConsume"')
...
class BranchCatalogApiTests(TestCase):
    def setUp(self):
        ...
        assign_membership(self.user, self.branch, ROLE_OPERATOR)
        self.vat = VatRate.objects.get(code="VAT14")
