...
Dates show as DD/MM/YYYY, in your local timezone (default Europe/Lisbon). Language (EN / pt-PT), theme, **Sign out**, and **Help** (placeholder) live in the **Settings** gear (top-right). Press **Escape** to close Settings.
