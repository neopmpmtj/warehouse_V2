...
- **Settings** gear (top-right) — signed in as *you@company*, small **Sign out** link on the Settings title row. **Help** is the blue **?** icon next to the gear (placeholder). Language and theme are set on the staff dashboard (`/`).
