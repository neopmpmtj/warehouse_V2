...
- **Current phase:** Phase 5 **in progress** — phases 0–4 done, **Slices 1–2 (tenancy + branch catalog) done**, full suite **338 tests green**. Plan authored: [`docs/phase5-plan-260821-1756.md`](phase5-plan-260821-1756.md). Decisions locked in [`docs/phase5-brainstorm-260821-1530.md`](phase5-brainstorm-260821-1530.md); roadmap [`docs/phase5-roadmap-260821-1618.md`](phase5-roadmap-260821-1618.md). **Next:** Slice 3 — requisição (internal request). See [`docs/handoff.md`](handoff.md).
...
| 5 | Branches + internal request + branch catalog | 🔜 **In progress** — Slices 1–2 ✅; Slice 3 next | Phase 4 |
...
**Status:** decisions locked 21 Aug 2026 — see [`phase5-brainstorm-260821-1530.md`](phase5-brainstorm-260821-1530.md) §Locked decisions and [`phase5-roadmap-260821-1618.md`](phase5-roadmap-260821-1618.md). **Build spec authored:** [`phase5-plan-260821-1756.md`](phase5-plan-260821-1756.md) (+ proposed additions A–D, §13). **Slices 1–2 ✅ done** — tenancy (`branches` app) and branch catalog (cost hidden, stock hint). **Next:** Slice 3 — requisição (internal request).
...
- Branch: read-only catalog (cost hidden, stock **hint** only); branch receipt + branch stock ledger still to come.
...
- [ ] Phase 5 — branches + internal request (implementation; see roadmap slices)
  ...
  - [ ] Slice 3 — requisição (internal request)
  - [ ] Slice 4 — goods issue
