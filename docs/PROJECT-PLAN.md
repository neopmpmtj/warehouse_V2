...
- **Current phase:** Phase 5 **in progress** — phases 0–4 done, **Slices 1–3 (tenancy + catalog + requisição) done**, full suite **358 tests green**. Plan authored: [`docs/phase5-plan-260821-1756.md`](phase5-plan-260821-1756.md). Decisions locked in [`docs/phase5-brainstorm-260821-1530.md`](phase5-brainstorm-260821-1530.md); roadmap [`docs/phase5-roadmap-260821-1618.md`](phase5-roadmap-260821-1618.md). **Next:** Slice 4 — goods issue. See [`docs/handoff.md`](handoff.md).
...
| 5 | Branches + internal request + branch catalog | 🔜 **In progress** — Slices 1–3 ✅; Slice 4 next | Phase 4 |
...
**Status:** decisions locked 21 Aug 2026 — see [`phase5-brainstorm-260821-1530.md`](phase5-brainstorm-260821-1530.md) §Locked decisions and [`phase5-roadmap-260821-1618.md`](phase5-roadmap-260821-1618.md). **Build spec authored:** [`phase5-plan-260821-1756.md`](phase5-plan-260821-1756.md) (+ proposed additions A–D, §13). **Slices 1–3 ✅ done** — tenancy (`branches` app), branch catalog (cost hidden, stock hint), and requisição (internal request). **Next:** Slice 4 — goods issue.
