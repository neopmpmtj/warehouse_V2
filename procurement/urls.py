...
urlpatterns = [
    ...
    path(
        "manage/purchase-orders/<int:po_id>/short-close/",
        console_views.manage_purchase_order_short_close,
        name="manage_purchase_order_short_close",
    ),
    path(
        "manage/purchase-orders/<int:po_id>/cancel/",
