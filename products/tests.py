...
class ItemConsoleTests(ItemTestCaseMixin, TestCase):
    ...
    def test_staff_can_open_console(self):
        ...
        self.assertContains(response, "console.js?v=32")
        self.assertContains(response, "console_i18n.js?v=31")
        self.assertContains(response, 'id="supplier-search"')
        self.assertNotContains(response, 'id="field-supplier"')
        self.assertNotContains(response, 'id="field-cost-price"')
        self.assertNotContains(response, 'id="genesis-supplier-fields"')
    ...
    def test_staff_can_open_dashboard(self):
        ...
        self.assertContains(response, 'href="/manage/incoming-from-branches/"')
        self.assertContains(response, 'href="/manage/stock-at-branches/"')
    ...
    def test_branch_membership_user_sees_branch_cards(self):
        ...
        self.assertContains(response, 'href="/branch/stock/"')
...
class CatalogConsoleTests(ItemTestCaseMixin, TestCase):
    ...
    def test_catalog_console_has_include_inactive_and_sortable_headers(self):
        ...
        self.assertContains(response, "catalog_i18n.js?v=15")
        self.assertContains(response, "select_fill.js?v=2")
...
"""
    ...
    def test_preferences_bar_includes_dashboard_card_keys(self):
        ...
        self.assertIn("cardSendToWarehouse:", source)
        self.assertIn("cardIncomingFromBranches:", source)
        self.assertIn("cardReturnedDispatches:", source)
        self.assertIn("cardStockAtBranches:", source)
        self.assertIn("Stock da filial", source)
        self.assertIn("Discrepâncias de receção e devoluções de expedição", source)
