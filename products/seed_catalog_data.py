...
ITEMS = (
    ("CEM-50", "Cimento 50 kg", "Cimento", "kg", "20", True, "VAT14"),
    ("CEM-25", "Cimento 25 kg", "Cimento", "kg", "15", True, "VAT14"),
    ("CEM-40", "Cimento 40 kg rápido", "Cimento", "kg", "25", True, "VAT14"),
    ("CEM-WHITE", "Cimento branco 25 kg", "Cimento", "kg", "10", True, "VAT14"),
    ("CEM-OLD", "Saco de cimento descontinuado", "Cimento", "kg", "0", False, "VAT14"),
    ("SAND-1KG", "Areia 1 kg", "Agregados", "kg", "50", True, "VAT14"),
    ("GRAVEL-10", "Brita 10 mm a granel", "Agregados", "kg", "30", True, "VAT14"),
    ("GRAVEL-20", "Brita 20 mm a granel", "Agregados", "kg", "40", True, "VAT14"),
    ("SAND-FINE", "Areia fina saco 25 kg", "Agregados", "kg", "0", True, "VAT14"),
    ("SAND-OLD", "Stock antigo de areia", "Agregados", "kg", "0", False, "VAT14"),
    ("PIPE-20", "Tubo de aço 20 mm", "Tubos", "m", "20", True, "VAT14"),
    ("PIPE-32", "Tubo de aço 32 mm", "Tubos", "m", "15", True, "VAT14"),
    ("PIPE-50", "Tubo PVC 50 mm", "Tubos", "m", "25", True, "VAT14"),
    ("PIPE-OLD", "Tubo obsoleto 15 mm", "Tubos", "m", "0", False, "VAT14"),
    ("STEEL-6", "Varão de aço 6 mm", "Aço", "m", "50", True, "VAT14"),
    ("STEEL-8", "Varão de aço 8 mm", "Aço", "m", "40", True, "VAT14"),
    ("STEEL-10", "Varão de aço 10 mm", "Aço", "m", "30", True, "VAT14"),
    ("STEEL-PLATE", "Chapa de aço 2 mm", "Aço", "m2", "10", True, "VAT14"),
    ("STEEL-OLD", "Varão de aço 12 mm enferrujado", "Aço", "m", "0", False, "VAT14"),
    ("TIMBER-2X4", "Madeira 2x4 3 m", "Madeira", "m", "15", True, "VAT14"),
    ("TIMBER-2X6", "Madeira 2x6 3 m", "Madeira", "m", "10", True, "VAT14"),
    ("TIMBER-PLY", "Folha de contraplacado 12 mm", "Madeira", "m2", "8", True, "VAT14"),
    ("TIMBER-OLD", "Feixe de madeira danificada", "Madeira", "m", "0", False, "VAT14"),
    ("HAMMER", "Martelo de unha 500 g", "Ferramentas", "piece", "5", True, "VAT14"),
    ("DRILL-18", "Conjunto de brocas 18 peças", "Ferramentas", "piece", "3", True, "VAT14"),
    ("SAW-CIRC", "Disco de serra circular 190 mm", "Ferramentas", "piece", "8", True, "VAT14"),
    ("LEVEL-60", "Nível de bolha 60 cm", "Ferramentas", "piece", "0", True, "VAT14"),
    ("TOOL-OLD", "Conjunto de cinzéis partidos", "Ferramentas", "piece", "0", False, "VAT14"),
    ("CABLE-2.5", "Cabo 2,5 mm 100 m", "Material elétrico", "m", "20", True, "VAT14"),
    ("CABLE-1.5", "Cabo 1,5 mm 100 m", "Material elétrico", "m", "15", True, "VAT14"),
    ("SOCKET", "Tomada dupla branca", "Material elétrico", "piece", "20", True, "VAT14"),
    ("SWITCH-1G", "Interruptor 1 tecla", "Material elétrico", "piece", "0", True, "VAT14"),
    ("ELEC-OLD", "Quadro elétrico antigo", "Material elétrico", "piece", "0", False, "VAT14"),
    ("VALVE-15", "Válvula de esfera 15 mm", "Canalização", "piece", "10", True, "VAT14"),
    ("TAP-CHROME", "Torneira misturadora cromada", "Canalização", "piece", "12", True, "VAT14"),
    ("FIT-90", "Joelho 90° 20 mm", "Canalização", "piece", "50", True, "VAT14"),
    ("PIPE-PEX", "Tubo PEX 16 mm", "Canalização", "m", "0", True, "VAT14"),
    ("PLUMB-OLD", "Stock de torneiras com fugas", "Canalização", "piece", "0", False, "VAT14"),
    ("PAINT-WHITE", "Tinta interior branca 10 L", "Tintas", "l", "8", True, "VAT14"),
    ("PAINT-GRAY", "Tinta exterior cinzenta 10 L", "Tintas", "l", "6", True, "VAT14"),
    ("PAINT-RED", "Tinta para metal vermelha 2,5 L", "Tintas", "l", "10", True, "VAT14"),
    ("PAINT-PRIMER", "Primário para madeira 5 L", "Tintas", "l", "0", True, "VAT14"),
    ("PAINT-OLD", "Balde de tinta expirada", "Tintas", "l", "0", False, "VAT14"),
    ("GLOVES-L", "Luvas de trabalho tamanho L", "Segurança", "piece", "30", True, "VAT14"),
    ("HELMET", "Capacete de segurança amarelo", "Segurança", "piece", "10", True, "VAT14"),
    ("GOGGLES", "Óculos de proteção transparentes", "Segurança", "piece", "15", True, "VAT14"),
    ("VEST-HIVIS", "Colete refletor laranja", "Segurança", "piece", "0", True, "VAT14"),
    ("SAFE-OLD", "Lote de luvas rasgadas", "Segurança", "piece", "0", False, "VAT14"),
    ("BOLT-M8", "Parafuso M8 x 50 embalagem 100", "Fixações", "piece", "20", True, "VAT14"),
    ("NUT-M8", "Porca M8 embalagem 100", "Fixações", "piece", "25", True, "VAT14"),
    ("SCREW-50", "Parafusos para madeira 50 mm caixa", "Fixações", "piece", "30", True, "VAT14"),
    ("WASHER-M8", "Anilha M8 embalagem 100", "Fixações", "g", "0", True, "VAT14"),
    ("FAST-OLD", "Mistura de parafusos enferrujados", "Fixações", "piece", "0", False, "VAT14"),
    ("TAPE-DUCT", "Fita adesiva 50 m", "Diversos", "piece", "10", True, "VAT14"),
    ("GLUE-EPOXY", "Cola epóxi bicomponente", "Diversos", "piece", "0", True, "VAT14"),
    ("ROPE-10", "Corda de polipropileno 10 mm 50 m", "Diversos", "m", "5", True, "VAT14"),
    ("CEMENT-MIX", "Betão pronto 25 kg", "Diversos", "kg", "20", True, "VAT14"),
    ("MISC-OLD", "Lote de ferragens desconhecidas", "Diversos", "piece", "0", False, "VAT14"),
