...
- **Offline catalogue and sync** (Phase 6 — **built**; review P0 hardening **next**)
- **Email automation** (Phase 8 — wire notify stubs to real email; stub exists)
- Order business rules not locked (stock timing, cart shape, cancel policy)
- Shared page chrome; branch phone-catalogue UX (Phase 7)
- Integration tests
