...
**Not done:** offline, shared chrome, branch phone UX, remaining console polish (`/` and `/branch/…` headers), production OAuth/deployment, **Phase 6 email automation**. Leftover 24 Aug review nits are **recorded in the review files, not a work queue** (threads N1–N6; Company Voice N1).
